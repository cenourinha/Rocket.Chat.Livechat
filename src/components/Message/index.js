...
export const Message = ({ _id, el, msg, ts, me, group, avatarUrl, attachmentsUrl, className, ...props }) => (
	<Body id={_id} me={me} group={group} el={el} className={className}>
		<Container>
			<Avatar src={avatarUrl} className={createClassName(styles, 'message__avatar')} />
			<Content>
